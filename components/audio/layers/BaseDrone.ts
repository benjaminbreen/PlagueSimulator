...
const DISTRICT_PROFILES: Record<DistrictType, DistrictProfile> = {
  ...
  // New historical districts - mapped to similar sonic profiles
  CEMETERY: {
    baseFreq: 45,
    harmonics: [1, 0.2, 0.1],
    noiseFreqLow: 40,
